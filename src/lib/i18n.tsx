...
const en: Dict = {
  ...
  "stats.supply": "Reliable Petroleum Supply",
  "stats.logistics": "Professional Logistics",
  "stats.deliveries": "Deliveries Completed",
  "stats.clients": "Satisfied Clients",

  "why.title": "Why Choose Taksan",
  "why.sub": "The values and capabilities that make us a trusted partner.",
  "why.1.t": "Trusted Industry Experience",
  "why.1.d": "Over 15 years of proven excellence in petroleum distribution.",
  "why.2.t": "High Quality Petroleum Products",
  "why.2.d": "Rigorous quality control at every stage of the supply chain.",
  "why.3.t": "Reliable Supply Chain",
  "why.3.d": "Consistent availability powered by strategic partnerships.",
  ...
  "values.customer": "Customer Satisfaction",
  "values.sustainability": "Sustainability",

  "products.title": "Our Products",
  "products.sub": "Premium petroleum products delivered with reliability and care.",
  "p.section.sig": "Significance",
  "p.section.challenges": "Industry Challenges",
  "p.section.gc": "Taksan as a Game Changer",
  "p.section.adv": "Advantages of Taksan",
  ...
  "team.title": "Our Team",
  "team.sub": "The leadership behind Taksan Energy Limited.",

  "contact.title": "Contact Us",
  "contact.sub": "Get in touch — we respond within one business day.",
  "form.name": "Full Name",
...
const fr: Dict = {
  ...
  "nav.services": "Services",
  "nav.why": "Pourquoi Taksan",
  "nav.team": "Équipe",
  "nav.contact": "Contact",
  "cta.contact": "Nous contacter",
  "cta.explore": "Voir les produits",
  ...
  "stats.supply": "Approvisionnement fiable",
  "stats.logistics": "Logistique professionnelle",
  "stats.deliveries": "Livraisons effectuées",
  "stats.clients": "Clients satisfaits",

  "why.title": "Pourquoi choisir Taksan",
  "why.sub": "Les valeurs et compétences qui font de nous un partenaire de confiance.",
  "why.1.t": "Expérience éprouvée",
  "why.1.d": "Plus de 15 ans d'excellence dans la distribution pétrolière.",
  "why.2.t": "Produits pétroliers de qualité",
  "why.2.d": "Contrôle qualité rigoureux à chaque étape.",
  "why.3.t": "Chaîne d'approvisionnement fiable",
  "why.3.d": "Disponibilité constante grâce à des partenariats stratégiques.",
  ...
  "values.excellence": "Excellence",
  "values.innovation": "Innovation",
  "values.customer": "Satisfaction client",
  "values.sustainability": "Durabilité",

  "products.title": "Nos Produits",
  "products.sub": "Produits pétroliers premium livrés avec fiabilité et soin.",
  "p.section.sig": "Importance",
  "p.section.challenges": "Défis du secteur",
  "p.section.gc": "Taksan, moteur de changement",
  "p.section.adv": "Les avantages Taksan",
  ...
  "contact.sub": "Écrivez-nous — nous répondons sous un jour ouvré.",
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const saved = typeof window !== "undefined" ? window.localStorage.getItem("taksan.lang") : null;
    if (saved === "en" || saved === "fr") setLangState(saved);
  }, []);

  const setLang = (l: Lang) => {
    setLangState(l);
    try { window.localStorage.setItem("taksan.lang", l); } catch {}
  };
