...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Taksan Energy Limited: 15+ years delivering premium petroleum products and energy solutions across Kenya, DRC and Mozambique." },
      { name: "author", content: "Taksan Energy Limited" },
      { property: "og:title", content: "Taksan Energy Limited — Reliable Petroleum Solutions" },
      { property: "og:description", content: "Premium petroleum products and dependable transportation services across Kenya, DRC and Mozambique." },
