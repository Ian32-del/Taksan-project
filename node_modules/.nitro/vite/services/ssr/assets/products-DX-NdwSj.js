import { n as useI18n } from "./i18n-Boua_Mqz.js";
import { n as SiteLayout, t as PageHeader } from "./Layout-jl0dGacP.js";
import { t as refinery_default } from "./refinery-DA4Q104l.js";
import { t as hero_terminal_default } from "./hero-terminal-B018N3ay.js";
import { t as tanker_truck_default } from "./tanker-truck-DfvqmTjD.js";
import { jsx, jsxs } from "react/jsx-runtime";
import { CheckCircle2, Flame, Fuel, Lightbulb, Truck } from "lucide-react";
//#endregion
...
function ProductsPage() {
	...
	return /* @__PURE__ */ jsxs(SiteLayout, { children: [/* @__PURE__ */ jsx(PageHeader, {
		eyebrow: "Products",
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-brand-deep/70 to-transparent" }),
							/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(Block, {
							...
							children: /* @__PURE__ */ jsx("ul", {
								...
								children: c.challenges.map((x) => /* @__PURE__ */ jsxs("li", {
									className: "flex items-start gap-2",
									children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-1.5 w-1.5 rounded-full bg-energy shrink-0" }), x]
								}, x))
							})
						}),
						/* @__PURE__ */ jsx(Block, {
						...
						/* @__PURE__ */ jsx(Block, {
							...
							children: /* @__PURE__ */ jsx("ul", {
								className: "grid sm:grid-cols-2 gap-2 text-sm",
								children: c.adv.map((x) => /* @__PURE__ */ jsxs("li", {
									className: "flex items-start gap-2",
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-brand mt-0.5 shrink-0" }), x]
								}, x))
							})
						})
					]
